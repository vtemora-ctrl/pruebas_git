...
echo "1. Ver que ha creado el hacker en la carpeta task"
echo "2. El hacker te ha dejado pistas ocultas en la carpeta"
echo "3. Hacer una copia de seguridad del contenido de la carpeta www a una carpeta nueva que debes crear y llamar backup"
echo "4. Renombrar el archivo index.html por index.html.backup"
echo "5. ¡Que empiece el juego!"
echo "======================================================="
